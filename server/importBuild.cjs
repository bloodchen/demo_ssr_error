...
(async () => {
  const { setImportBuildGetters } = await import('../../node_modules/.pnpm/vite-plugin-ssr@0.4.142_vite@4.5.1/node_modules/vite-plugin-ssr/dist/esm/node/runtime/globalContext/loadImportBuild.js');
